...
function grabMainCity() {
    async function queryMainCity() {
        ...
        try {
            ...
            systemSettings.mainCity.locationID = data.location.icaoCode[0];
            ...
            systemSettings.LBar.locations.cities[0] = {
                ...
                locationID: data.location.icaoCode[0],
            }
    ...
    async function autoMainCity() {
        ...
        systemSettings.mainCity.locationID = icaoData.location.stationId[icId];
        

        if (systemSettings.upperDisplayCity.autoFind == true) {
            systemSettings.upperDisplayCity.locationID = icaoData.location.stationId[icId];
        }

        if (systemSettings.health.autoFind == true) {
            systemSettings.health.locationID = icaoData.location.stationId[icId];
        }
        ...
        systemSettings.LBar.locations.cities[0] = {
            ...
            lat: data.lat,
            lon: data.lon,
            locationID: icaoData.location.stationId[icId]
        }
    ...
    if (mainquery != undefined && mainquery != "nationalForecast" && mainquery != "debugJoeMist") {
        queryMainCity()
    } else {
